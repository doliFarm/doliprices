...
/**
 * \file    test/phpunit/DolipricesFunctionalTest.php
 * \ingroup doliprices
...
/**
 * Class DolipricesFunctionalTest
 *
 ...
 *
 * @package Testdoliprices
 */
class DolipricesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoliprices')->click();
		} else {
			// Disable the module
			$this->byHref('modDoliprices')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/doliprices/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('doliprices/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/doliprices/admin/about.php');
		$this->authenticate();
		return $this->assertContains('doliprices/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolipriceswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliprices_DolipricesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliprices_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
